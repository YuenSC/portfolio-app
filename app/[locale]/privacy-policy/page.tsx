export default function Page() {
  return (
    <div className="container flex flex-col gap-4 py-10">
      ...
      <p className="text-base">Last updated: July 28, 2024</p>
      ...
      <ul className="list-inside list-disc space-y-4 text-base">
        ...
        <li>
          <strong>Application</strong> refers to Group Bill, the software
          program provided by the Company.
        </li>
        <li>
          <strong>Company</strong> (referred to as either &quot;the
          Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
          this Agreement) refers to Group Bill.
        </li>
        <li>
      ...
      <ul className="list-inside list-disc space-y-4 text-base">
        <li>By email: groupexpense.calvin@gmail.com</li>
      </ul>
    </div>
  );
}
